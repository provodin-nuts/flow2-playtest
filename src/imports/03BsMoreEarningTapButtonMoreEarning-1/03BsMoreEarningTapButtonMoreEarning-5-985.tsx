import svgPaths from "./svg-o9r8zzq3yf";
...
function Text() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[2px] items-start min-w-px not-italic relative text-white" data-name="Text">
      ...
      <p className="font-['Montserrat:Medium',sans-serif] leading-[16px] overflow-hidden relative shrink-0 text-[14px] text-ellipsis tracking-[0.14px] w-full">Everything best — in one subscription</p>
    </div>
  );
}
...
function LabelContent() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-start not-italic relative shrink-0 text-white w-full" data-name="Label Content">
      ...
      <p className="font-['Montserrat:Medium',sans-serif] leading-[16px] min-h-[48px] relative shrink-0 text-[14px] tracking-[0.14px] w-full">activate the earnings boost</p>
    </div>
  );
}
...
function LabelContent1() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-start not-italic relative shrink-0 text-white w-full" data-name="Label Content">
      <p className="font-['Russo_One:Regular',sans-serif] leading-[20px] relative shrink-0 text-[16px] tracking-[0.16px] w-full">Rewards for tasks</p>
...
export default function Component03BsMoreEarningTapButtonMoreEarning() {
  return (
    <div className="backdrop-blur-[50px] bg-gradient-to-b content-stretch flex flex-col from-[#323232] gap-[20px] items-center justify-end pb-[32px] pt-[8px] relative rounded-tl-[28px] rounded-tr-[28px] size-full to-[#161616] to-[30%]" data-name="03_BS — More Earning [tap: Button More earning]">
