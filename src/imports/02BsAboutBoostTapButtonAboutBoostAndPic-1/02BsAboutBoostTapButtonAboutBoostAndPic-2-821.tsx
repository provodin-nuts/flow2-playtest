import svgPaths from "./svg-a7clpwrwg1";
...
function BottomSheet() {
  return (
    <div className="-translate-x-1/2 absolute backdrop-blur-[50px] bg-gradient-to-b bottom-[-86px] content-stretch flex flex-col from-[#323232] gap-[20px] items-center left-1/2 pb-[32px] pt-[8px] rounded-tl-[28px] rounded-tr-[28px] to-[#161616] to-[30%] w-[360px]" data-name="Bottom Sheet">
